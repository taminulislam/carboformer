_base_ = [
    '_base_/models/carbnformer.py', '_base_/datasets/co2.py',
]

crop_size = (512, 512)
data_preprocessor = dict(size=crop_size)
checkpoint = './checkpoint/carboformer/iter_160000.pth'  # noqa
model = dict(
...
# Only override the size parameter
data_preprocessor = dict(
    _base_=data_preprocessor,  # Inherit from base config
    size=crop_size
)
